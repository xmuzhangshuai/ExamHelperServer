...
function deleteCollect(pageNow) {
	scscms_alert("确定要删除收藏吗？","confirm",function(){
...
function delSelected(){
	scscms_alert("确定要删除所选收藏吗？","confirm",function(){
		scscms_alert("删除成功！","ok");
	},function(){});
}
</script>
			...
			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<td height="40" class="font42">
					<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
						<tr class="CTitle">
							<td height="22" colspan="13" align="center" style="font-size:18px">用户收藏</td>
						</tr>
						<tr bgcolor="#EEEEEE">
						...
						<c:forEach items="${scollectionList}" var="scollection" varStatus="loop">
							<tr id="listbg" onclick="goCollectionDetail(${scollection.id});" >
								...
								<td height="20" align="center" ><label style="font-weight: bold;">${scollection.collectionNum}</label></td>
								<td height="20" align="center">
									<a  onclick="deleteCollect(${pageNow});" id="">
