...
function deleteExamGuide(pageNow,examGuideId) {
	scscms_alert("确定要删除考试指南文章吗？","confirm",function(){
		document.getElementById("fom").action = "${pageContext.request.contextPath}/examGuide.do?flag=deleteExamGuide&pageNow="+pageNow+"&examGuideId="+examGuideId;
...
function delSelected(){
	scscms_alert("确定要删除所选考试指南文章吗？","confirm",function(){
		scscms_alert("删除成功！","ok");
	},function(){});
}
</script>
					...
					<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
						...
						<c:forEach items="${examGuideList}" var="examGuide">
							<tr id="listbg">
								...
								<td height="20" align="center"><label>${examGuide.time}</label></td>
								<td height="20" align="center">
									<a  onclick="deleteExamGuide(${pageNow},${examGuide.id});" id="">
