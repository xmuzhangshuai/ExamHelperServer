	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading : 'images/lightbox-ico-loading.gif', // (string) Path
																...
																// of the
																// loading icon
			imageBtnPrev : 'images/lightbox-btn-prev.gif', // (string) Path and
															// the name of the
															// prev button image
			imageBtnNext : 'images/lightbox-btn-next.gif', // (string) Path and
															// the name of the
															// next button image
			imageBtnClose : 'images/lightbox-btn-close.gif', // (string) Path
																...
																// of the close
																// btn
			imageBlank : 'images/lightbox-blank.gif', // (string) Path and the
														// name of a blank image
														// (one pixel)
			// Configuration related to container image box
			containerBorderSize : 10, // (integer) If you adjust the padding
			...
			// Configuration related to texts in caption. For example: Image 2
			// of 8. You can alter either "Image" and "of" texts.
			txtImage : 'Image', // (string) Specify text "Image"
			txtOf : 'of', // (string) Specify text "of"
			// Configuration related to keyboard navigation
			keyToClose : 'c', // (string) (c = close) Letter to close the
								// jQuery lightBox interface. Beyond this
								// letter, the letter X and the SCAPE key is
								// used to.
			keyToPrev : 'p', // (string) (p = previous) Letter to show the
								// previous image
			keyToNext : 'n', // (string) (n = next) Letter to show the next
								// image.
		...
		function _set_image_to_view() { // show the loading
			...
			objImagePreloader.onload = function() {
				...
				if (objImagePreloader.width > $(window).width()) {
					...
					intImageHeight = parseInt(intImageWidth
				...
				if (intImageHeight > $(window).height()) {
					...
					intImageWidth = parseInt(intImageHeight * intImageWidth
							/ mh);
				} else {
					intImageHeight = objImagePreloader.height;
				}
